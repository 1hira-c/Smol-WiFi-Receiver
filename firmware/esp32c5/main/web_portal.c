...
static const char index_html[] =
	...
	"<title>SlimeVR Smol Gateway</title><style>body{font-family:sans-serif;max-width:42rem;margin:2rem auto;padding:0 1rem}"
	...
	"<body><h1>SlimeVR Smol Gateway</h1><pre id=s>Loading...</pre><form id=f>"
