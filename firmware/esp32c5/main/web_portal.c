...
static const char index_html[] =
	...
	"<input name=country value=JP maxlength=2 required><input name=server placeholder='Bridge IPv4 or hostname (optional)'>"
	"<input name=serverPort value=6970 type=number min=1 max=65535><button>Save and reboot</button></form>"
